...
angular.module("htmlToPdfSave").directive("pdfSaveButton", ["$rootScope", "$pdfStorage", function(t, e) {
    return {
        restrict: "A",
        link: function(n, o, a) {
            e.pdfSaveButtons.push(o),
            n.buttonText = "Button",
            o.on("click", function() {
                ...
                function f(t, e) {
                    function n() {
                        o().then(function(t) {
                            ...
                            n.addImage(e, "JPEG", 20, 20),
                            n.save("chart-reports.pdf"),
                            a.width(d)
                        })
                    }
                    function o() {
                        return a.width(1.33333 * f[0] - 80).css("max-width", "none"),
                        html2canvas(a, {
                            imageTimeout: 2e3,
                            removeContainer: !0
                        })
